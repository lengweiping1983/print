...
FABRIC_PROMPTS_DATA = [
    {
        ...
        "code": "01",
        "name": "高端梭织面料面料",
        "scenarios": "西装、衬衫、套装、商务面料、成衣基础面料",
        "category": "面料",
        "prompt": "生成一张专业服装面料背景图。\n以【参数1：面料主体 例如：细斜纹羊毛】为核心，\n体现【参数2：工艺与视觉风格 例如：高端成衣】的高级感，\n整体色彩采用【参数3：色彩气质 例如：深灰黑+冷银】。\n\n要求呈现真实梭织纤维组织、\n细密经纬结构、\n自然光下的微弱层次变化，\n可用于高端服装面料开发参考。\n\n画面具有完整平铺逻辑，四边自然衔接，可连续扩展。\n呈现纯面料面料 / 图案背景，构图干净，细节稳定。\n高细节，面料清晰，纤维层次丰富，专业面料质感，适合服装印花、贴图、裁片铺图。",
    },
    {
        "id": "fp-02",
        "code": "02",
        "name": "针织肌理",
        "scenarios": "毛衣、卫衣、针织衫、秋冬面料、弹力面料",
        "category": "面料",
        "prompt": "生成一张专业针织类服装面料背景图。\n以【参数1：面料主体 例如：柔软针织罗纹】为核心，\n表现【参数2：工艺与视觉风格 例如：日系极简】的针织质感，\n整体色彩采用【参数3：色彩气质 例如：奶油白+浅米色】。\n\n要求看到细微线圈感、\n针路规律、\n柔软弹性、\n轻微蓬松纤维触感，\n整体适合服装面料开发与数字贴图。\n\n画面适合连续平铺扩展，边缘过渡自然。\n呈现纯针织面料背景，面料清晰，层次丰富，适合大面积应用。",
    },
    {
        "id": "fp-03",
        "code": "03",
    ...
    },
    {
        ...
        "category": "面料",
        "prompt": "生成一张服装材质类背景图。\n以【参数1：面料主体 例如：牛仔磨白颗粒】为基础材质，\n风格体现【参数2：工艺与视觉风格 例如：复古做旧】，\n配色采用【参数3：色彩气质 例如：靛蓝+灰白】。\n\n要求表现真实布面颗粒、\n旧化层次、\n轻微磨白感、\n洗水过渡、\n纤维细节。\n\n整体保持专业面料贴图感。\n画面适合连续扩展，面料自然，材质真实，适合牛仔与工装面料开发。",
    },
    {
        "id": "fp-07",
        "code": "07",
    ...
    },
    {
        ...
        "category": "面料",
        "prompt": "生成一张科技机能风服装面料背景。\n以【参数1：面料主体 例如：微科技织纹】为主要图案基础，\n融合【参数2：工艺与视觉风格 例如：未来数字感】的未来感与功能性，\n整体配色采用【参数3：色彩气质 例如：黑灰银+冷蓝】。\n\n要求具有微科技织纹、\n功能面料颗粒、\n细密网格、\n压纹或热压感。\n\n整体专业、克制，\n适合运动与机能服饰。\n高细节，面料清晰，科技感强，适合机能服饰与数码主题面料开发。",
    },
    {
        "id": "fp-10",
        "code": "10",
